...
var scaling_factor = 10.0 # 7/100th the screen width
...
func _move_scale_pause_btn() -> void:
	...
	var height_factor = 0.5 #Buttons can't be slightly offscreen? SO only need half its height, its already on the screen
